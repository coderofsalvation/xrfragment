...
class Test:
    _hx_class_name = "Test"
    __slots__ = ()
    _hx_statics = ["errors", "main", "test", "equalX", "equalXY", "equalXYZ", "equalMediaFragment"]
    ...
    def test(topic,spec):
        ...
        while (_g < _g1):
            ...
            if (Reflect.field(Reflect.field(item,"expect"),"fn") == "testEmbedOverride"):
                valid = (Reflect.field(Reflect.field(item,"expect"),"out") == python_Boot.hasField(xrfragment_URI.parse(Reflect.field(item,"data"),xrfragment_XRF.METADATA),Reflect.field(Reflect.field(item,"expect"),"input")))
            ...
            if (Reflect.field(Reflect.field(item,"expect"),"fn") == "equal.x"):
            ...
            if (Reflect.field(Reflect.field(item,"expect"),"fn") == "equal.mediafragmentUV"):
                valid = Test.equalMediaFragment(res,item,"uv")
            if (Reflect.field(Reflect.field(item,"expect"),"fn") == "equal.mediafragmentS"):
    ...
    def equalX(res,item):
        if ((not Reflect.field(Reflect.field(item,"expect"),"out")) and (not Reflect.field(res,Reflect.field(Reflect.field(item,"expect"),"input")))):
            ...
            return (Reflect.field(Reflect.field(item,"expect"),"out") == Std.string(Reflect.field(Reflect.field(res,Reflect.field(Reflect.field(item,"expect"),"input")),"x")))
        else:
            return False
    ...
    def equalMediaFragment(res,item,key):
        if ((not Reflect.field(Reflect.field(item,"expect"),"out")) and (not Reflect.field(res,Reflect.field(Reflect.field(item,"expect"),"input")))):
            ...
            return (HxOverrides.arrayGet(Reflect.field(Reflect.field(res,key),"floats"), Std.parseInt(Reflect.field(Reflect.field(item,"expect"),"input"))) == Std.parseFloat(Reflect.field(Reflect.field(item,"expect"),"out")))
Test._hx_class = Test
...
class HxOverrides:
    ...
    __slots__ = ()
    _hx_statics = ["iterator", "eq", "stringOrNull", "filter", "length", "arrayGet"]
